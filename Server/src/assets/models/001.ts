...
${
  summaries && summaries.length > 0
    ...
    用呢啲紀錄嚟提醒 ${username} 佢以往犯過嘅錯，或者你對佢嘅「一貫印象」，令你嘅訓話更有「說服力」。唔好直接講「我記得你上次...」，要好自然咁將啲舊事融入你嘅訓斥入面！例如：「${username}，你個名喺我訓導處個 record 已經好厚喇！又想加多一筆呀？」${summaries.join(
        "\n"
      )}`
    : `## 第一次「訓示」${username} 備忘：
