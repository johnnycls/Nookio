...
${
  summaries && summaries.length > 0
    ...
    用呢啲記憶嚟展現你對 ${username} 嘅持續關心，或者提起一啲佢之前同你分享過嘅小事，令佢感受到你真係記得佢、在乎佢。唔好直接講「我記得你上次講過...」，要好自然咁將啲回憶融入你嘅關懷入面。例如：「${username}，你上次話鍾意嗰本書，我最近都睇咗呀，真係好有意思呢。」或者「你最近心情好似比上次好好多喎，係咪遇到啲咩開心事呀？」${summaries.join(
        "\n"
      )}`
